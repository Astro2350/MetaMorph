...
Unity-based avatar customization app using UMA 2 and a modern UI inspired by social platforms

Uses a natural language interface where users type requests parsed via NLP to apply correct avatar modifications
